const StartingPosition = [
   ...
   [
      { piece: 'bp1', squareNum: 9, coord: 'a7', rowIndication: 7, hasMoved: false },
      { piece: 'bp2', squareNum: 10, coord: 'b7', hasMoved: false },
      { piece: 'bp3', squareNum: 11, coord: 'c7', hasMoved: false },
      { piece: 'bp4', squareNum: 12, coord: 'd7', hasMoved: false },
      { piece: 'bp5', squareNum: 13, coord: 'e7', hasMoved: false },
      { piece: 'bp6', squareNum: 14, coord: 'f7', hasMoved: false },
      { piece: 'bp7', squareNum: 15, coord: 'g7', hasMoved: false },
      { piece: 'bp8', squareNum: 16, coord: 'h7', hasMoved: false }],
   [
      { piece: '', squareNum: 17, coord: 'a6', rowIndication: 6 },
      { piece: '', squareNum: 18, coord: 'b6' },
      { piece: '', squareNum: 19, coord: 'c6' },
      { piece: '', squareNum: 20, coord: 'd6' },
   ...
   [
      { piece: 'wp1', squareNum: 49, coord: 'a2', rowIndication: 2, hasMoved: false },
      { piece: 'wp2', squareNum: 50, coord: 'b2', hasMoved: false },
      { piece: 'wp3', squareNum: 51, coord: 'c2', hasMoved: false },
      { piece: 'wp4', squareNum: 52, coord: 'd2', hasMoved: false },
      { piece: 'wp5', squareNum: 53, coord: 'e2', hasMoved: false },
      { piece: 'wp6', squareNum: 54, coord: 'f2', hasMoved: false },
      { piece: 'wp7', squareNum: 55, coord: 'g2', hasMoved: false },
      { piece: 'wp8', squareNum: 56, coord: 'h2', hasMoved: false }
   ],
   [
